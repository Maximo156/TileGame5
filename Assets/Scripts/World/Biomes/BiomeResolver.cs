...
{
    public static JobHandle ResolveBasicBiomes(int chunkWidth, NativeArray<int2> chunks, FractalSound MoistureSound, FractalSound HeatSound, ref BiomeData biomeData, NativeBiomeInfo biomeInfo)
    {
        ...
        return JobHandle.CombineDependencies(moistureMap.Dispose(resolveBiomeJob), heatMap.Dispose(resolveBiomeJob));
    }
